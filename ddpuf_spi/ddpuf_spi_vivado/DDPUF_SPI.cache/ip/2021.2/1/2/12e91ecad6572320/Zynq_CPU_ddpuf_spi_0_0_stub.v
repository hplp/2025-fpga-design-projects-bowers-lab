...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(SCLK, MOSI, MISO, SS_N, CLK, RST_N, FSM_Complete, 
  Duration, FSM_Start, PUF_Val)
/* synthesis syn_black_box black_box_pad_pin="SCLK,MOSI,MISO,SS_N,CLK,RST_N,FSM_Complete,Duration[15:0],FSM_Start,PUF_Val[127:0]" */;
  input SCLK;
  input MOSI;
  output MISO;
  input SS_N;
