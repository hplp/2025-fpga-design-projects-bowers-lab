...
(* CORE_GENERATION_INFO = "Zynq_CPU,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Zynq_CPU,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_clkrst_cnt=5,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "Zynq_CPU.hwdef" *) 
module Zynq_CPU
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  (* DEBUG = "true" *) (* MARK_DEBUG *) wire [127:0]xlconstant_1_dout;
  ...
  Zynq_CPU_system_ila_1_0 system_ila_1
       (.clk(processing_system7_0_FCLK_CLK0),
        .probe0(processing_system7_0_SPI1_MOSI_O));
  Zynq_CPU_system_ila_2_0 system_ila_2
       (.clk(processing_system7_0_FCLK_CLK0),
        .probe0(xlconstant_1_dout));
  Zynq_CPU_system_ila_3_0 system_ila_3
       (.clk(processing_system7_0_FCLK_CLK0),
        .probe0(Duration));
