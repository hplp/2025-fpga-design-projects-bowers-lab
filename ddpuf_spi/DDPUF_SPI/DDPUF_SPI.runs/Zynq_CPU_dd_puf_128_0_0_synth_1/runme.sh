...
HD_PWD='C:/Users/auste/FPGA_Projects/DDPUF_SPI/DDPUF_SPI.runs/Zynq_CPU_dd_puf_128_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq_CPU_dd_puf_128_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zynq_CPU_dd_puf_128_0_0.tcl
